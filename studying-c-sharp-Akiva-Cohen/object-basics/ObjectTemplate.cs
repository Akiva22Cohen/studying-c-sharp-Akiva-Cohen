...
namespace c_sharp_basics_lingar.object_basics
{
    public class ObjectTemplate
    {
        ...
        public void ToggleBoolProperty() { boolProperty = !boolProperty; }
    ...
    public class ObjectPattern
    {
        ...
        public void SetBoolProperty(bool boolProperty) { this.boolProperty = boolProperty; }

        public static void PrintOBJ(ObjectPattern objectPattern)
        {
            Console.WriteLine($"ObjectPattern:\n\tintProperty = {objectPattern.intProperty}" +
                $"\n\tstring property = {objectPattern.stringProperty}" +
                $"\n\tboolProperty ={objectPattern.boolProperty} ");
            Console.WriteLine();
        }
        ...
        public static void Demo() 
        {
            ...
            PrintOBJ(objectPattern);

            objectPattern.intProperty = 32;
            objectPattern.stringProperty = "Hello World!";
            objectPattern.SetBoolProperty(!objectPattern.boolProperty);
